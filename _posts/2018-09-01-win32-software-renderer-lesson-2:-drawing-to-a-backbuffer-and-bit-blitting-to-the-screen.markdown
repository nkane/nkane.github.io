...
typically called *integrated graphics processors*, but our program that we will be writing will not be using any type of graphics acceleration. Great, now that we have a few basic concepts
covered, what is real-time rendering and how is that different than generic software rendering?
